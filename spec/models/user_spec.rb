...
describe User do
  ...
  it "should have a password confirmation attribute" do
    ...
    it "should requre matching password confirmation" do
    ...
    it "shoud set the encrypted password attribute" do
  ...
  describe "authenticate method"  do
    ...
    it "should return the user on email/match" do
...
describe "relationships" do
  ...
  it "should follow another user" do
    ...
    it "should include the follwed user in the following array" do
      @user.follow!(@followed)
